...
<?php include('header.php'); ?>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Titre html1</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 1</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 2</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
            <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 3</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 4</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 5</h2>
        ...
        ?>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 5 - autre version</h2>

        <h3> Fonction paire : vérifie si un nombre est pair à partir d'un formulaire</h3>
        <div>
            <form action="action.php" method="GET" style='display: flex;gap:1rem; margin:1rem;padding: 1rem 2rem;'>
                <label for="numberToTest">Saisissez un nombre à tester : </label>
                <input  style='margin-left:1rem;' type="number" name="numberToTest" id="numberToTest">
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 6</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;''>Exercice 7</h2>
        ...
        <?php
            ...
            echo 'un triangle de cote '.$b.'cm et '.$c.'cm  aura une longueur d\'hypothenus égale à '.$a.'cm <br>';
        ?>
    
    </section>

    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 8</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 9</h2>
        ...
        <<pre style='border: 2px solid yellow; border-radius:5px;background:#222;color:#fff;padding:2rem 5rem 2rem 1rem;width:max-content;'>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 10</h2>
        ...
        <?php
            ...
            for ( $i = 1 ; $i <= 100 ; $i++) {
                ...
                if ( ( ( $i % 5 ) == 0) && ( ( $i % 3 ) == 0) ) {
                    echo "<p style='line-height:.5rem;'>le nombre $i est un multiple de 3 et de 5 donc :<span style='padding:.2rem .5rem; color:#fff;background-color:purple;font-weight:bold;'>foobar </span></p>";
                } elseif ( ( $i % 5 ) == 0 ){
                    echo "<p style='line-height:.5rem;'>le nombre $i est un multiple 5 donc : <span style='padding:.2rem .5rem; color:#fff;background-color:blue;font-weight:bold;'>bar</span></p>";
                } elseif ( ( ( $i % 3 ) == 0 ) ){
                    echo "<p style='line-height:.5rem;'>le nombre $i est un multiple de 3 donc : <span style='padding:.2rem .5rem; color:#fff;background-color:red;font-weight:bold;'>foo </span></p>";
                } else {
                    echo "<p style='line-height:.5rem;'>le nombre $i est... quelconque </p>";
                }
        }
        ?>
            <h2>EXERCICE 10 AUTRE MÉTHODE SUGGESTION SABRINA</h2>
            <h3>Utilisation de switch case</h3>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 11</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 12</h2>
        <h3> tableaux fighterx</h3>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 13</h2>
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 14</h2>
        ...
        <p>
            <?php
                ...
                echo "<table style='border:1px;border-style:solid;border-color:green;border-radius:8px;'><thead style='background-color:#c5c5c5;'><td style='padding:.8rem;border-top-left-radius:8px;'>Index</td><td style='font-weight:bold;padding:.8rem;border-top-right-radius:8px;'>Valeur</td></thead><tbody>";
                        
                foreach( $integersArray as $key => $value ){
                    echo "<tr>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;''>".$key."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".$value."</td>
                    </tr>";
                }
                echo "</tbody>";
                echo "<tfoot>
                        <tr style='background-color:#;'>
                            <td style='padding:.8rem;'>Total :</td>
                            <td style='font-weight:bold;padding:.8rem;'>".array_sum( $integersArray )."</td>
                        </tr>
                    </tfoot>
                </table>";
    ...
    <section style='border:solid 2px #000; margin-bottom:2rem; background-color:#ececec;padding: 2rem 5rem;'>
        <h2 style='padding:.5rem .8rem; background-color:#333;color:#e4e4e4;text-transform:uppercase; margin:1rem auto;text-align:center;'>Exercice 15</h2>
        <h3>Table des multiplications</h3>
        <blockquote>faire le tableau des multiplications</blockquote>
        <p>
            <?php
                $multiplicateur1 = 1;
                $multiplicateur2 = 2;
                ...
                echo "<table style='border:1px;border-style:solid;border-color:green;border-radius:8px;'>
                <thead style='background-color:#c5c5c5;'>
                <td style='padding:.8rem;border-top-left-radius:8px;'>Multiples</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur1."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur2."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur3."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur4."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur5."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur6."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur7."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur8."</td>
                <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;width:1rem;'>".$multiplicateur9."</td>
                </thead>
                <tbody>";                   
                    for( $key = 1 ; $key < 10 ; $key++ ){
                    echo "<tr>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;background-color:#c5c5c5;'>".$key."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur1)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur2)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur3)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur4)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur5)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur6)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur7)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur8)."</td>
                        <td style='border:1px;border-style:solid;border-color:black;padding:.5rem;text-align:center;'font-weight:bold;'>".multiply( $key,$multiplicateur9)."</td>
                    </tr>";
                    }
                echo "</tbody>
                    </table>";
